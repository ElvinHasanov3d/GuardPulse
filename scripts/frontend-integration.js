 ...
 * This file demonstrates how to integrate Guardpulse with a web frontend
 */

// For React/Vue/Angular applications
export class GuardpulseClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new GuardpulseClient(provider, contractAddress);
